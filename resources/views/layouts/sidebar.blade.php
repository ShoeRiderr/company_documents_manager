<div class="max-w-2xl mr-auto h-full">
    <aside class="w-64 h-full" aria-label="Sidebar">
        <div class="px-3 py-4 overflow-y-auto rounded h-full bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 h-fit">
                <li>
                    <a href="/"
                ...
                <li>
                    <a href="{{route('invoices.index')}}"
                        ...
                        {{trans('general.side_menu.invoices')}}
                    </a>
                </li>
            </ul>
        </div>
